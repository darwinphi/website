    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex-1 flex items-start py-8">
        ...
        >
          ...
          <div className="flex flex-col gap-4 md:col-span-1 md:sticky md:top-24 md:self-start md:max-h-[calc(100vh-8rem)] md:overflow-y-auto lg:col-span-1 lg:sticky lg:top-24 lg:self-start lg:max-h-[calc(100vh-8rem)] lg:overflow-y-auto">
