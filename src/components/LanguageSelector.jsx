...
function LanguageSelector() {
  ...
  return (
    <div className="relative" data-lang-selector>
      ...
      {isOpen && (
        <div className="absolute bottom-full mb-2 right-0 bg-primary-bg dark:bg-primary-bg-dark rounded shadow-lg border border-current dark:border-border-dark z-50 min-w-[180px]">
